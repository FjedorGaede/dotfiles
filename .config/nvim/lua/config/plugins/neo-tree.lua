      ...
      local default_config = {
        ...
        window = { -- see https://github.com/MunifTanjim/nui.nvim/tree/main/lua/nui/popup for
          ...
          mappings = {
            ...
            ["J"] = nextSibling,
            ["e"] = function()
              -- this is an idea how to deal with switching between neo-tree and oil for editing files
              local state = require("neo-tree.sources.manager").get_state("filesystem")
              local cursor_node = state.tree:get_node()

              local path = require("plenary.path"):new(cursor_node:get_id())
              ...
              require("oil").toggle_float(absolute_path)
            end,
